    ...
    >
      ...
      <div className='w-full flex justify-between items-center lg:hidden'>
        ...
        <nav className=' flex items-center justify-center flex-wrap'>
          <motion.a
            href='https://github.com/GonzaloVolonterio/'
            target={'_blank'}
            className=' w-6 mx-3'
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
        ...
        >
          ...
          <nav className=' flex items-center justify-center flex-wrap mt-2'>
            <motion.a
              ...
              aria-label='Link to Gonzalo Volonterio profile on Github'
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.9 }}
            >
              <GithubIcon />
            ...
            <motion.a
              href='https://www.linkedin.com/in/gonzalovolonterio/'
              target={'_blank'}
              className='social-link linkedin-link w-6 mx-3 sm:mx-1'
              rel='noopener noreferrer'
              aria-label='Link to GonzaloVolonterio profile on Github'
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.9 }}
            >
              <LinkedInIcon />
